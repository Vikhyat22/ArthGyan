...
const StockDetailPage = () => {
  ...
  if (isLoading) { return <p className="text-gray-400">Loading stock details...</p>; }
  if (!stock) { return <div><h1 className="text-3xl font-bold text-white">Stock Not Found</h1><p className="text-gray-400 mt-4">Could not find data for ticker: {ticker}</p></div>; }
